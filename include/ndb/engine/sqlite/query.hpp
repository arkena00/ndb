...
namespace ndb
{
    ...
    public:
        ...
        void bind_value(const T& value)
        {
            ...
            else if constexpr (std::is_same_v<string_, storage_type>) sqlite3_bind_text(statement_, bind_index_, ndb::type_data(value), -1, SQLITE_TRANSIENT); //TODO: use SQLITE_STATIC
