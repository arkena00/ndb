...
public:
    ...
    String(const char* in, unsigned len);
...
namespace detail
{
    ...
    #if DOCTEST_MSVC
        #define DOCTEST_FUNCTION_NAME __FUNCSIG__
        constexpr static unsigned typename_front = sizeof("const char *__cdecl doctest::detail::type_to_string<") - 1;
        constexpr static unsigned typename_back = sizeof(">(void)");
    #else
        #define DOCTEST_FUNCTION_NAME __PRETTY_FUNCTION__
        constexpr static unsigned typename_front = sizeof("const char* doctest::detail::type_to_string() [with T = ") - 1;
        constexpr static unsigned typename_back = sizeof("]");
    #endif

    template <typename T>
    const char* type_to_string() {
        return DOCTEST_FUNCTION_NAME;
    }
} // namespace detail
...
String::String(const char* in, unsigned in_len)
{
    if(in_len <= last) {
...
String::String(const char* in) : String::String(in, detail::my_strlen(in)) {}
...
namespace detail
{
    ...
    TestCase& TestCase::operator*(const char* in) {
        ...
        if(m_template_id != -1) {
            unsigned typename_size = detail::my_strlen(m_type) - detail::typename_front - detail::typename_back + 1;
            m_full_name = String(m_name) + "<" + String(m_type + detail::typename_front, typename_size) + ">";
